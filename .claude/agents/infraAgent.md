...
1. **Varra código e documentação** em busca de:
   ...
   - **Arquitetura de transição** (`docs/transition-architecture.md`): trade-offs conscientemente adiados (instância única de banco, ausência de HA) continuam coerentes com o que o código de fato implementa?

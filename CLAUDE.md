...
- **Observabilidade**: OpenTelemetry desde o início (vendor-neutral), não SDK de vendor específico — funciona igual local (console/Aspire Dashboard) e Azure (Monitor).
